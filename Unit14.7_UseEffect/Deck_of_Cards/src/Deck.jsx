...
// Function to get a new deck with ID. useState to maintain
function Deck() {
  ...
  // Async function to get card value and image with error handling
  async function draw() {
    try {
  ...
  //Enable draw button (disabled if shuffling) 
